...
namespace Information_Management_System
{
    public partial class Accounts : Form
    {
        ...
        void GetUsers()
        {
            ...
            conn.Close();
            DGVacc.EnableHeadersVisualStyles = false;
            DGVacc.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;  // Make columns auto resize
        ...
        private void TBsearch_TextChanged(object sender, EventArgs e)
        {
            ...
            string searchQuery = "SELECT * FROM Medicine WHERE [Position] LIKE @i OR [Username] like @i";
